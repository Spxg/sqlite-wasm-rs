...
pub const SQLITE3MC_VERSION_MINOR: i32 = 3;
pub const SQLITE3MC_VERSION_RELEASE: i32 = 5;
pub const SQLITE3MC_VERSION_SUBRELEASE: i32 = 0;
pub const SQLITE3MC_VERSION_STRING: &::core::ffi::CStr = c"SQLite3 Multiple Ciphers 2.3.5";
...
pub struct sqlite3_mem_methods {
    ...
    pub xInit: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut ::core::ffi::c_void) -> ::core::ffi::c_int,
    >,
    pub xShutdown: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut ::core::ffi::c_void),
    >,
    pub pAppData: *mut ::core::ffi::c_void,
}
...
pub type sqlite3_destructor_type = ::core::option::Option<
    unsafe extern "C" fn(arg1: *mut ::core::ffi::c_void),
>;
extern "C" {
...
pub struct sqlite3_mutex_methods {
    ...
    >,
    pub xMutexFree: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_mutex),
    >,
    pub xMutexEnter: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_mutex),
    >,
    pub xMutexTry: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_mutex) -> ::core::ffi::c_int,
    >,
    pub xMutexLeave: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_mutex),
    >,
...
pub struct sqlite3_pcache_methods2 {
    ...
    >,
    pub xDestroy: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_pcache),
    >,
...
pub struct sqlite3_rtree_geometry {
    ...
    pub xDelUser: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut ::core::ffi::c_void),
    >,
}
extern "C" {
    pub fn sqlite3_rtree_query_callback(
        ...
        xQueryFunc: ::core::option::Option<
            unsafe extern "C" fn(
                arg1: *mut sqlite3_rtree_query_info,
            ) -> ::core::ffi::c_int,
        >,
        pContext: *mut ::core::ffi::c_void,
        xDestructor: ::core::option::Option<
            unsafe extern "C" fn(arg1: *mut ::core::ffi::c_void),
        >,
    ) -> ::core::ffi::c_int;
}
...
extern "C" {
    pub fn sqlite3session_changeset_size(
        pSession: *mut sqlite3_session,
    ) -> sqlite3_int64;
}
extern "C" {
...
extern "C" {
    pub fn sqlite3changeset_finalize(
        pIter: *mut sqlite3_changeset_iter,
    ) -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    pub fn sqlite3changegroup_new(
        pp: *mut *mut sqlite3_changegroup,
    ) -> ::core::ffi::c_int;
}
extern "C" {
...
pub struct Fts5ExtensionApi {
    ...
    >,
    pub xColumnCount: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut Fts5Context) -> ::core::ffi::c_int,
    >,
    ...
    >,
    pub xPhraseCount: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut Fts5Context) -> ::core::ffi::c_int,
    >,
    ...
    >,
    pub xRowid: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut Fts5Context) -> sqlite3_int64,
    >,
...
extern "C" {
    pub fn sqlite3_activate_see(zPassPhrase: *const ::core::ffi::c_char);
}
extern "C" {
    pub fn sqlite3mc_cipher_count() -> ::core::ffi::c_int;
}
extern "C" {
    pub fn sqlite3mc_cipher_index(
        cipherName: *const ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn sqlite3mc_cipher_name(
        cipherIndex: ::core::ffi::c_int,
    ) -> *const ::core::ffi::c_char;
}
extern "C" {
    pub fn sqlite3mc_cipher_name_copy(
        cipherIndex: ::core::ffi::c_int,
        cipherName: *mut ::core::ffi::c_char,
        maxCipherNameSize: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    pub fn sqlite3mc_version() -> *const ::core::ffi::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _CipherParams {
    pub m_name: *const ::core::ffi::c_char,
    pub m_value: ::core::ffi::c_int,
    pub m_default: ::core::ffi::c_int,
    pub m_minValue: ::core::ffi::c_int,
    pub m_maxValue: ::core::ffi::c_int,
}
...
pub type AllocateCipher_t = ::core::option::Option<
    unsafe extern "C" fn(db: *mut sqlite3) -> *mut ::core::ffi::c_void,
>;
pub type FreeCipher_t = ::core::option::Option<
    unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void),
>;
pub type CloneCipher_t = ::core::option::Option<
    unsafe extern "C" fn(
        cipherTo: *mut ::core::ffi::c_void,
        cipherFrom: *mut ::core::ffi::c_void,
    ),
>;
pub type GetLegacy_t = ::core::option::Option<
    unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void) -> ::core::ffi::c_int,
>;
pub type GetPageSize_t = ::core::option::Option<
    unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void) -> ::core::ffi::c_int,
>;
pub type GetReserved_t = ::core::option::Option<
    unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void) -> ::core::ffi::c_int,
>;
pub type GetSalt_t = ::core::option::Option<
    unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void) -> *mut ::core::ffi::c_uchar,
>;
pub type GenerateKey_t = ::core::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::core::ffi::c_void,
        userPassword: *mut ::core::ffi::c_char,
        passwordLength: ::core::ffi::c_int,
        rekey: ::core::ffi::c_int,
        cipherSalt: *mut ::core::ffi::c_uchar,
    ),
>;
pub type EncryptPage_t = ::core::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::core::ffi::c_void,
        page: ::core::ffi::c_int,
...
>;
pub type DecryptPage_t = ::core::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::core::ffi::c_void,
        page: ::core::ffi::c_int,
        data: *mut ::core::ffi::c_uchar,
...
extern "C" {
    pub fn sqlite3mc_register_cipher(
        ...
        makeDefault: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn sqlite3mcCheckVfs(zVfs: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn sqlite3mc_vfs_create(
        zVfsReal: *const ::core::ffi::c_char,
        makeDefault: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn sqlite3mc_vfs_destroy(zName: *const ::core::ffi::c_char);
}
extern "C" {
