...
impl OpfsSAHPool {
    ...
    // acquire_access_handles() for how it behaves if it throws due to
...
impl OpfsSAHPoolUtil {
    ...
    pub fn pause_vfs(&self, force: bool) -> Result<()> {
        self.pool.pause_vfs(force)
    }
