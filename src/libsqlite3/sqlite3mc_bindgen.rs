...
pub const SQLITE3MC_VERSION_STRING: &::std::ffi::CStr = c"SQLite3 Multiple Ciphers 2.2.6";
pub const SQLITE_VERSION: &::std::ffi::CStr = c"3.51.1";
pub const SQLITE_VERSION_NUMBER: i32 = 3051001;
pub const SQLITE_SOURCE_ID: &::std::ffi::CStr = c"2025-11-28 17:28:25 281fc0e9afc38674b9b0991943b9e9d1e64c6cbdb133d35f6f5c87ff6af38a88";
pub const SQLITE_SCM_BRANCH: &::std::ffi::CStr = c"branch-3.51";
pub const SQLITE_SCM_TAGS: &::std::ffi::CStr = c"release version-3.51.1";
pub const SQLITE_SCM_DATETIME: &::std::ffi::CStr = c"2025-11-28T17:28:25.933Z";
...
pub struct sqlite3_io_methods {
    ...
    >,
    pub xShmBarrier: ::std::option::Option<
...
pub struct sqlite3_mem_methods {
    ...
    pub xInit: ::std::option::Option<
        unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int,
    >,
    pub xShutdown: ::std::option::Option<
        unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void),
    >,
    pub pAppData: *mut ::std::os::raw::c_void,
}
...
pub type sqlite3_destructor_type = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void),
>;
extern "C" {
...
pub struct sqlite3_rtree_geometry {
    ...
    pub xDelUser: ::std::option::Option<
        unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void),
    >,
}
extern "C" {
...
extern "C" {
    pub fn sqlite3rebaser_create(
        ppNew: *mut *mut sqlite3_rebaser,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
pub type AllocateCipher_t = ::std::option::Option<
    unsafe extern "C" fn(db: *mut sqlite3) -> *mut ::std::os::raw::c_void,
>;
pub type FreeCipher_t = ::std::option::Option<
    unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void),
>;
