use rsqlite_vfs::{
    test_suite::{
        test_vfs_store, test_vfs_store_delete_on_close, test_vfs_store_open_modes,
        test_vfs_store_reopen,
    },
    *,
};
...
impl VfsStore for Store {
    ...
    fn open_file(data: &Rc<State>, request: OpenRequest<'_>) -> VfsResult<OpenedFile<Self::File>> {
...
#[test]
fn test_invalid_store_is_rejected() {
